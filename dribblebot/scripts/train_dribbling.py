...
def train_go1(args):
    ...
    if method == "mlp":
      ...
      from dribblebot_learn.ppo_aug.ppo import PPO_Args
      ...
      from dribblebot_learn.ppo_symm.ppo import PPO_Args
    ...
    if method == "mlp":
      ...
      project = "dribbling_aug"
    elif method == "emlp":
      project = "dribbling_emlp"
